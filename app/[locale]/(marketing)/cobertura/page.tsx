            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {PRIORITY_COMMUNES.map((commune) => (
                <Link
                  ...
                  className="group rounded-(--radius-xl) bg-surface-container border border-outline-variant/20 p-5 flex flex-col gap-2 hover:border-primary/40 hover:shadow-ambient transition-[border-color,box-shadow]"
                >
