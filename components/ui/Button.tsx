...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    'bg-secondary-container text-on-secondary-container font-semibold hover:brightness-95 active:scale-[0.98]',
  ghost:
    'text-primary font-medium underline-offset-4 hover:underline hover:text-primary-container',
}
